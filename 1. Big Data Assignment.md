...
If I had been able to run the code and continue, I would have:
...
I was unable to complete part 3. 
I attempted to separate the 25 context networks using graph projection to create named graphs of each:
...
RETURN a,b,r
```
I wanted to add the weight property to this graph but couldn't figure out how. 

One I had this graph database of all 25 networks, I would use the following algorithms:
